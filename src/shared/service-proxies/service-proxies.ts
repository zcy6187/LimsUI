...
export class Assay_DataSearchServiceProxy {
     ...
     * @return Success
     */
    getExcelNameByTemplateIdAndSpecId(input: number | null | undefined, specId: number[] | null | undefined, begin: Date | null | undefined, endTime: Date | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Assay_DataSearch/GetExcelNameByTemplateIdAndSpecId?";
        if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&"; 
        if (specId !== undefined)
            specId && specId.forEach(item => { url_ += "specId=" + encodeURIComponent("" + item) + "&"; });
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetExcelNameByTemplateIdAndSpecId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetExcelNameByTemplateIdAndSpecId(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetExcelNameByTemplateIdAndSpecId(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getExcelNameBySelfCode(selfTplId: number | null | undefined, begin: Date | null | undefined, endTime: Date | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Assay_DataSearch/GetExcelNameBySelfCode?";
        if (selfTplId !== undefined)
            url_ += "selfTplId=" + encodeURIComponent("" + selfTplId) + "&"; 
        if (begin !== undefined)
            url_ += "begin=" + encodeURIComponent(begin ? "" + begin.toJSON() : "") + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetExcelNameBySelfCode(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetExcelNameBySelfCode(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetExcelNameBySelfCode(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class Assay_TplServiceProxy {
     ...
     * @return Success
     */
    getTplsByOrgId(orgId: number | null | undefined): Observable<EditTplDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_Tpl/GetTplsByOrgId?";
        if (orgId !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTplsByOrgId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTplsByOrgId(<any>response_);
                } catch (e) {
                    return <Observable<EditTplDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetTplsByOrgId(response: HttpResponseBase): Observable<EditTplDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class Assay_UserTplServiceProxy {
     ...
     * @return Success
     */
    getUserOrgIdsByUserId(userId: number | null | undefined): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserOrgIdsByUserId?";
        if (userId !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserOrgIdsByUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserOrgIdsByUserId(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserOrgIdsByUserId(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getUserOrgIds(): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserOrgIds";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserOrgIds(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserOrgIds(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserOrgIds(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getUserTplIdsByUserId(userId: number | null | undefined): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserTplIdsByUserId?";
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserTplIdsByUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserTplIdsByUserId(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserTplIdsByUserId(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getUserTplIds(): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserTplIds";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserTplIds(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserTplIds(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserTplIds(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getUserTplSpecIdsByUserId(tplId: number | null | undefined, userId: number | null | undefined): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserTplSpecIdsByUserId?";
        if (tplId !== undefined)
            url_ += "tplId=" + encodeURIComponent("" + tplId) + "&"; 
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserTplSpecIdsByUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserTplSpecIdsByUserId(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserTplSpecIdsByUserId(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getUserTplSpecIds(tplId: number | null | undefined): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserTplSpecIds?";
        if (tplId !== undefined)
            url_ += "tplId=" + encodeURIComponent("" + tplId) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserTplSpecIds(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserTplSpecIds(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserTplSpecIds(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    postAddOrUpdateTplSpecByTplIdAndUserId(tplId: number | null | undefined, specIds: string | null | undefined, uid: number | null | undefined): Observable<HtmlDataOperRetDto> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/PostAddOrUpdateTplSpecByTplIdAndUserId?";
        if (tplId !== undefined)
            url_ += "tplId=" + encodeURIComponent("" + tplId) + "&"; 
        if (specIds !== undefined)
            url_ += "specIds=" + encodeURIComponent("" + specIds) + "&"; 
        if (uid !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPostAddOrUpdateTplSpecByTplIdAndUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPostAddOrUpdateTplSpecByTplIdAndUserId(<any>response_);
                } catch (e) {
                    return <Observable<HtmlDataOperRetDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPostAddOrUpdateTplSpecByTplIdAndUserId(response: HttpResponseBase): Observable<HtmlDataOperRetDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    postAddOrUpdateUserOrgsByUserId(orgIds: string | null | undefined, uid: number | null | undefined): Observable<HtmlDataOperRetDto> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/PostAddOrUpdateUserOrgsByUserId?";
        if (orgIds !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPostAddOrUpdateUserOrgsByUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPostAddOrUpdateUserOrgsByUserId(<any>response_);
                } catch (e) {
                    return <Observable<HtmlDataOperRetDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPostAddOrUpdateUserOrgsByUserId(response: HttpResponseBase): Observable<HtmlDataOperRetDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    postAddOrUpdateOrgTplsByUserId(orgId: string | null | undefined, tplIds: string | null | undefined, uid: number | null | undefined): Observable<HtmlDataOperRetDto> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/PostAddOrUpdateOrgTplsByUserId?";
        if (orgId !== undefined)
            url_ += "orgId=" + encodeURIComponent("" + orgId) + "&"; 
        if (tplIds !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPostAddOrUpdateOrgTplsByUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPostAddOrUpdateOrgTplsByUserId(<any>response_);
                } catch (e) {
                    return <Observable<HtmlDataOperRetDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPostAddOrUpdateOrgTplsByUserId(response: HttpResponseBase): Observable<HtmlDataOperRetDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getUserTplIdsByOrgId(orgId: number | null | undefined): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserTplIdsByOrgId?";
        if (orgId !== undefined)
            url_ += "orgId=" + encodeURIComponent("" + orgId) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserTplIdsByOrgId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserTplIdsByOrgId(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
     ...
     * @return Success
     */
    getUserTplIdsByOrgCodeAndUserId(orgCode: string | null | undefined, userId: number | null | undefined): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Assay_UserTpl/GetUserTplIdsByOrgCodeAndUserId?";
        if (orgCode !== undefined)
            url_ += "orgCode=" + encodeURIComponent("" + orgCode) + "&"; 
        if (userId !== undefined)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserTplIdsByOrgCodeAndUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserTplIdsByOrgCodeAndUserId(<any>response_);
                } catch (e) {
                    return <Observable<string[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserTplIdsByOrgCodeAndUserId(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class DetectServiceProxy {
     ...
     * @return Success
     */
    downLoadExcelBySpecId(input: number | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Detect/DownLoadExcelBySpecId?";
        if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDownLoadExcelBySpecId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDownLoadExcelBySpecId(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDownLoadExcelBySpecId(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    searchDuplicateItems(tplSpecId: number | null | undefined, beginTime: Date | null | undefined, endTime: Date | null | undefined, searchId: string | null | undefined, dateType: number | null | undefined): Observable<TableInfoDto> {
        let url_ = this.baseUrl + "/api/services/app/Detect/SearchDuplicateItems?";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSearchDuplicateItems(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSearchDuplicateItems(<any>response_);
                } catch (e) {
                    return <Observable<TableInfoDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TableInfoDto>><any>_observableThrow(response_);
        }));
    }

    protected processSearchDuplicateItems(response: HttpResponseBase): Observable<TableInfoDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? TableInfoDto.fromJS(resultData200) : new TableInfoDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TableInfoDto>(<any>null);
    }
     ...
     * @return Success
     */
    searchDuplicateModificationItems(tplSpecId: number | null | undefined, beginTime: Date | null | undefined, endTime: Date | null | undefined, searchId: string | null | undefined, dateType: number | null | undefined): Observable<ModifyTableInfoDto> {
        let url_ = this.baseUrl + "/api/services/app/Detect/SearchDuplicateModificationItems?";
        if (tplSpecId !== undefined)
            url_ += "tplSpecId=" + encodeURIComponent("" + tplSpecId) + "&"; 
        if (beginTime !== undefined)
            url_ += "beginTime=" + encodeURIComponent(beginTime ? "" + beginTime.toJSON() : "") + "&"; 
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSearchDuplicateModificationItems(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSearchDuplicateModificationItems(<any>response_);
                } catch (e) {
    ...
    protected processSearchDuplicateModificationItems(response: HttpResponseBase): Observable<ModifyTableInfoDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getSingleModifyInfo(dupId: number | null | undefined): Observable<ModifyEditInfoDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Detect/GetSingleModifyInfo?";
        if (dupId !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetSingleModifyInfo(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetSingleModifyInfo(<any>response_);
                } catch (e) {
                    return <Observable<ModifyEditInfoDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<ModifyEditInfoDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetSingleModifyInfo(response: HttpResponseBase): Observable<ModifyEditInfoDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(ModifyEditInfoDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
...
export class UserDataDto implements IUserDataDto {
    ...
    tplIds: string | undefined;
    tplSpecList: TplSpecDto[] | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.tplIds = data["tplIds"];
            if (data["tplSpecList"] && data["tplSpecList"].constructor === Array) {
                this.tplSpecList = [];
                for (let item of data["tplSpecList"])
                    this.tplSpecList.push(TplSpecDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["tplIds"] = this.tplIds;
        if (this.tplSpecList && this.tplSpecList.constructor === Array) {
            data["tplSpecList"] = [];
            for (let item of this.tplSpecList)
                data["tplSpecList"].push(item.toJSON());
        }
        return data; 
    }
...
export class TplSpecDto implements ITplSpecDto {
    tplId: string | undefined;
    specIds: string | undefined;

    constructor(data?: ITplSpecDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TplSpecDto {
        data = typeof data === 'object' ? data : {};
        let result = new TplSpecDto();
        result.init(data);
        return result;
    }
...
export class TableInfoDto implements ITableInfoDto {
    ...
    constructor(data?: ITableInfoDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["titleInfo"] && data["titleInfo"].constructor === Array) {
                this.titleInfo = [];
                for (let item of data["titleInfo"])
                    this.titleInfo.push(ElementTitleInfo.fromJS(item));
            }
            if (data["dataList"] && data["dataList"].constructor === Array) {
                this.dataList = [];
                for (let item of data["dataList"])
    ...
    static fromJS(data: any): TableInfoDto {
        data = typeof data === 'object' ? data : {};
        let result = new TableInfoDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (this.titleInfo && this.titleInfo.constructor === Array) {
            data["titleInfo"] = [];
            for (let item of this.titleInfo)
                data["titleInfo"].push(item.toJSON());
        }
        if (this.dataList && this.dataList.constructor === Array) {
            data["dataList"] = [];
            for (let item of this.dataList)
...
export interface ITableInfoDto {
    titleList: string[] | undefined;
    titleInfo: ElementTitleInfo[] | undefined;
    dataList: string[][] | undefined;
}

export class ElementTitleInfo implements IElementTitleInfo {
    eleId: number | undefined;
    eleName: string | undefined;
    eleCount: number | undefined;
    ...
    constructor(data?: IElementTitleInfo) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.eleName = data["eleName"];
            this.eleCount = data["eleCount"];
            this.operCount = data["operCount"];
            this.columnCount = data["columnCount"];
        }
    }

    static fromJS(data: any): ElementTitleInfo {
        data = typeof data === 'object' ? data : {};
        let result = new ElementTitleInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["eleName"] = this.eleName;
        data["eleCount"] = this.eleCount;
        data["operCount"] = this.operCount;
        data["columnCount"] = this.columnCount;
        return data; 
    }

    clone(): ElementTitleInfo {
        const json = this.toJSON();
        let result = new ElementTitleInfo();
        result.init(json);
        return result;
...
export interface IElementTitleInfo {
    eleId: number | undefined;
    eleName: string | undefined;
    eleCount: number | undefined;
    operCount: number | undefined;
...
export class ModifyEditInfoDto implements IModifyEditInfoDto {
    ...
    init(data?: any) {
        if (data) {
            this.eleId = data["eleId"];
            this.eleName = data["eleName"];
            this.duplicationStr = data["duplicationStr"];
            this.eleValue = data["eleValue"];
        }
    }

    static fromJS(data: any): ModifyEditInfoDto {
        data = typeof data === 'object' ? data : {};
        let result = new ModifyEditInfoDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["eleId"] = this.eleId;
        data["eleName"] = this.eleName;
        data["duplicationStr"] = this.duplicationStr;
        data["eleValue"] = this.eleValue;
        return data; 
    }

    clone(): ModifyEditInfoDto {
        const json = this.toJSON();
        let result = new ModifyEditInfoDto();
        result.init(json);
        return result;
...
export interface IModifyEditInfoDto {
    eleId: number | undefined;
    eleName: string | undefined;
    duplicationStr: string | undefined;
    eleValue: number | undefined;
